...
**Figure 30 – Creating the Router hEX RB750Gr3 entry**  
...
**Figure 31 – Router monitored successfully**  
...
**Figure 32 – Creating the Switch RB260GS entry**  
...
**Figure 33 – Switch monitored successfully**  
...
# 11. Creating custom dashboards for the homelab

Once the Zabbix server is fully configured and all hosts are added (backup server, Proxmox hypervisor, router and switch), the next step is to build dashboards that provide a quick overview of the homelab status.  
Dashboards are created from **Monitoring → Dashboards** and can contain widgets such as host availability, problems list, graphs, and resource usage.
...
## 11.1 Main dashboard – global rack overview
...
**Figure 34 – Main dashboard with global availability and recent problems**  
...
## 11.2 Network devices dashboard

The **Network devices** dashboard focuses on the router hEX RB750Gr3 and the RB260GS switch.  
Its goal is to monitor link status, interface traffic and basic health (disk and memory) for the network layer of the homelab.

<img src="../docs/Zabbix/network_devices_dashboard1.png" width="90%" />

**Figure 35 – Network devices overview: availability, router disk and memory**  
...
**Figure 36 – Router interfaces and traffic graphs**  
...
**Figure 37 – Switch interfaces and per‑port traffic**  
...
## 11.3 Servers dashboard

The **Servers** dashboard concentrates on the backup SERVER, the Proxmox hypervisor and the Zabbix server.  
It provides CPU, memory, disk usage and network traffic for each node, allowing a quick check of resource utilization.

<img src="../docs/Zabbix/servers_dashboard1.png" width="90%" />

**Figure 38 – Servers overview and Backup Server resources**  
...
**Figure 39 – Proxmox Server resources and VM interface traffic**  
...
**Figure 40 – Zabbix Server resources and Tailscale traffic**  
